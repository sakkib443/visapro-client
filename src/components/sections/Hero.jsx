        ...
        <section className="relative min-h-[100svh] lg:min-h-[75vh] flex flex-col overflow-hidden bg-[#0a1a14]">
            ...
            <div className="relative z-20 w-full max-w-7xl mx-auto px-5 sm:px-6 flex-1 flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    >
                        <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 bg-[#EF8C2C] hover:bg-[#D97A1E] text-white rounded-xl font-bold text-xs transition-all shadow-lg hover:-translate-y-1">
                            <LuCalendarCheck className="w-4 h-4" />
                            Book Appointment
                        </button>
                        <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3.5 bg-white/20 backdrop-blur-md border border-white/40 hover:bg-white/30 text-white rounded-xl font-bold text-xs transition-all hover:-translate-y-1">
